...
export default {
  ...
  "options": {
    ...
    "chooseDownloadLocation": "选择文件夹",
    "resetDownloadLocation": "恢复默认目录",
    "downloadLocationDefaultHint": "正在使用默认下载位置。",
    "downloadLocationCustomHint": "正在使用自定义下载位置。",
    "downloadLocationMoved": "已将 {{count}} 个已下载文件迁移到新位置。",
    "downloadLocationMoveFailed": "{{count}} 个文件迁移失败。",
    ...
    "wasapiExclusive": "WASAPI 独占输出（bit-perfect）",
    ...
    "wasapiModeOff": "已关闭",
    "wasapiModeExclusiveToast": "已切换到 WASAPI 独占输出",
    "wasapiModeSharedToast": "已回退到共享模式",
